...
public class FlamesCandle {
    ...
    static ArrayList<Character> userNameLetters = new ArrayList<>();
    static ArrayList<Character> crushNameLetters = new ArrayList<>();

    static ArrayList<Character> uniqueLetters;
    static ArrayList<String> FLAMES;

    public static String runFlames(String userNameInput, String crushNameInput) {

        userNameLetters.clear();
        crushNameLetters.clear();
        initializeFlameLetters();
    ...
    private static void initializeFlameLetters() {
        FLAMES = new ArrayList<String>(
                List.of("FRIENDS",
                        "LOVERS",
                        "ADMIRERS",
                        "MARRIAGE",
